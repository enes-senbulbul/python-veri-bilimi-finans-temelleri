# Python, SQL, Veri Bilimi ve Finans Temelleri — Öğrenme Günlüğü

Devasa bir quant projesi geliştirebilecek yetkinlikte olmam için bayaaaa bir şey öğrenmem gerekiyormuş.
- Kendime hedef koyduğum proje: 
...
| 5 | Pandas & NumPy ile Veri Analizi | ⬜ Başlanmadı | — | — | [Detaylı Harita](05-pandas-numpy/README.md) |
| 6 | İstatistik (Olasılık ve Çıkarımsal) | ⬜ Başlanmadı | — | — | [Detaylı Harita](06-istatistik/README.md) |
| 7 | Ekonometri (Zaman Serisi) | ⬜ Başlanmadı | — | — | [Detaylı Harita](07-ekonometri/README.md) |
| 8 | Makine Öğrenmesi Temelleri | ⬜ Başlanmadı | — | — | [Detaylı Harita](08-makine-ogrenmesi/README.md) |
| 9 | Quantitative Finance Temelleri | ⬜ Başlanmadı | — | — | [Detaylı Harita](09-quant-finance-temelleri/README.md) |
...
│
│── 02-git/                         (aynı yapı)
├── 03-veri-muhendisligi/           (aynı yapı)
├── 04-sql/                         (aynı yapı)
├── 05-pandas-numpy/                (aynı yapı)
├── 06-istatistik/                  (aynı yapı)
├── 07-ekonometri/                  (aynı yapı)
├── 08-makine-ogrenmesi/            (aynı yapı)
└── 09-quant-finance-temelleri/     (aynı yapı)
```
